                                    ...
                                    <li>
                                        <div className="item">
                                            ...
                                            <div className="textwidget">
                                                <p>Our Glorious saga since 1990, Anuj Steel Centre has carved a niche in the roofing market. We are the leading authorized Distributors in Kolhapur for many renowned brands like Georoof, Bhushan Power & Steel, Essar</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div className="day_item">
                                                                <span className="day">1430/A, 'C' Ward Near Lokmat Sambhaji Pul, Laxmipuri, Kolhapur, Maharashtra 416002</span>
                                                                {/* <span className="hours">9am to 5pm</span> */}
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="day_item">
                                                                <span className="day">+91 94225 20381
                                                                    <br />   +91 9405229558</span>
                                                                {/* <span className="hours">10am to 3pm</span> */}
                                                            </div>
                                                        </li>
                                                        <li>
                                                            <div className="day_item">
                                                                <span className="day">info@anujsteel.com</span>
                                    ...
                                    <li>
                                        <div className="item">
                                            ...
                                            <div className="widget_nav_menu">
                                                <ul className="menu">
                                                    <li><Link href="/services"><a>Home</a></Link></li>
                                                    <li><Link href="#"><a>About</a></Link></li>
                                                    <li><Link href="#"><a>Downloads</a></Link></li>
                    ...
                    <div className="container">
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; 2022 Anuj Steel. All rights reserved.</p>
                            </div>
                            <Link href="#">
