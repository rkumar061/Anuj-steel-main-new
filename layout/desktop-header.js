            ...
            <div className="industify_fn_header">
                ...
                <div className="industify_fn_toppanel">
                    <div className="left_panel">
                        <div className="info">
                            <Link href="tel:07787744741"><a>(0940) 522 - 955 -8</a></Link>
                        </div>
                        <div className="info">
                            <Link href="mailto:rendycoder.com@gmail.com"><a>
                                infol@anujsteel.com</a></Link>
                        </div>
                ...
                <div className="header_inner">
                    ...
                    <div className="menu_nav">
                        <ul className="industify_fn_main_nav vert_nav">
                            ...
                            <li className="menu-item-has-children">
                                <a>Projects</a>
                                <ul className="sub-menu">
                                    <li><a>METAL & TILE ROOFING SHEET</a>
                                        <ul className="sub-menu">
                                    ...
                                    <li><a>POLYCARBONATE /UPVC ROOFING SHEET</a>
                                        <ul className="sub-menu">
                                    ...
                                    <li><Link href="/service-single-7"><a>RUN WATER GUTTER & SOLUTION</a></Link>
                                        <ul className="sub-menu">
                                            <li><Link href="/egur"><a>EURO GUARD UPVC RAIN WATER GUTTER</a></Link></li>
                                        </ul>
                                    </li>
                                    <li><Link href="/service-single-6"><a>INTERIOIR / EXTERIOR CELING PRODUCTS</a></Link>
                                        <ul className="sub-menu">
                                    ...
                                    <li><Link href="/service-single-5"><a>PLATES & SHEETS</a></Link>
                                        <ul className="sub-menu">
                                            ...
                                            <li><Link href="/404"><a>STRUCTURAL STEEL</a></Link></li>
                                        </ul>
                                    </li>
                                    <li><Link href="/service-single-4"><a>ROOFING ACCESSORIES</a></Link>
                                        <ul className="sub-menu">
                    ...
                    <div className="toll_free_lang">
                        ...
                        <div className="toll_free">
                            ...
                            <div className="tf_in">
                                <div className="img_holder" style={{ backgroundImage: `url(${background})`, fontWeight: "bold" }}></div>
                                <p><span>Toll Free:</span>  (0940) 522 - 955 -8</p>
                            </div>
                        </div>
