...
export default function ServiceSingle1() {
	return (
		<>
		<Title title='Oralium Alumnium Roofing Sheet & Tile' />
			<Layout>
				{/* Page Title  */}
				<div className="industify_fn_pagetitle">
					<div className="container">
						<div className="title_holder">
							<h3>Oralium Alumnium Roofing Sheet & Tile</h3>
							<div className="industify_fn_breadcrumbs">
								<ul>
									...
									<li className="separator"><span></span></li>
									<li><span className="bread-current">Oralium Alumnium Roofing Sheet & Tile</span></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div className="s_inner">
							...
							<div className="industify_fn_leftsidebar">
								...
								<div className="industify_fn_service_single">
                                    ...
                                    <div class="desc_holder"><p>Today, Aluminium is the most widely used non-ferrous metal in construction, especially in developed countries. From small buildings to huge complexes, Aluminium is just the right material for constructions, thanks to its unique properties. Aluminium is lightweight, yet strong. It is non-corrosive, durable, sleek and versatile. Aluminium helps to create aesthetically pleasing structures that are long-lasting and low on maintenance.</p><p>Taking an exceptional role in the Aluminium revolution in India is Oralium, one of India's largest Aluminium Roofing Sheets Brand.</p></div>
