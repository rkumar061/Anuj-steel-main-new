            ...
            <div className="title_holder">
              ...
              <div className="industify_fn_breadcrumbs">
                <ul>
                  ...
                  <li>
                    <span className="bread-current">DUOTAPP</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="industify_fn_leftsidebar">
                ...
                <div className="industify_fn_service_single">
                  ...
                  <div class="img_holder">
                    <img src="/img/DUOTAPP-450x163.jpg" alt="" />
                  </div>
                  ...
                  >
                    <tbody>
                      ...
                      <tr>
                        <td valign="top" bgcolor="#FFFFFF" width="30%">
                          <div align="left">
                            <strong>Timber Penetration</strong>
                          </div>
                        </td>
                        <td valign="top" bgcolor="#FFFFFF">
                          <div align="left">min 25mm penetration</div>
                        </td>
                      </tr>
                      <tr>
                        <td valign="top" bgcolor="#FFFFFF">
                        ...
                        <td valign="top" bgcolor="#FFFFFF">
                          <div align="left">Black cut EPDM washer</div>
                        </td>
                      </tr>
                      <tr>
                        <td valign="top" bgcolor="#FFFFFF">
