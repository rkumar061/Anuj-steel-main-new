                        ...
                        <div className="title_holder">
                            ...
                            <div className="industify_fn_breadcrumbs">
                                <ul>
                                    ...
                                    <li className="separator"><span></span></li>
                                    <li><span className="bread-current">Onduline Light Weight Roofing Sheet</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="s_inner">
                            ...
                            <div className="industify_fn_leftsidebar">
                                ...
                                <div className="industify_fn_service_single">
                                    ...
                                    <div class="img_holder"><img src="/img/onduline-duro.png" alt="" /></div>
                                    <h3>INTRODUCTION</h3>
                                    <div className="desc_holder">
                                        <p>Onduline proposes opaque roofing solutions for all sectors, both for new building and for renovation. We offer a large choice of opaque roofing materials to match all your needs, with a variety of designs and aesthetic finishes, from large roofing sheets to smaller tiles or shingles, and waterproofing membranes for pitched and flat roofs. We also propose over-roofing solutions, a roof over the roof to avoid leakages and improve the comfort inside.</p>
                                    </div>
									...
									<p>Lightweight and ideal for all types of applications.</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>High wind resistant</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Thermal and acoustic comfort</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Waterproofing Guaranteed</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>10% Higher coverage surface</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Eco-friendly and safe</p></div></li>
									</ul></div>
									...
									<p>Housing</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span>
									<p>Leisure housing</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span>
									<p>Public access</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span>
									<p>Auxiliaries</p></div></li>
									</ul></div>
