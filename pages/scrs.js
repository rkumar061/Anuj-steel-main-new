						...
						<div className="title_holder">
							...
							<div className="industify_fn_breadcrumbs">
								<ul>
									...
									<li className="separator"><span></span></li>
									<li><span className="bread-current">Stone Coated Roofing Sheet</span></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div className="s_inner">
							...
							<div className="industify_fn_leftsidebar">
								...
								<div className="industify_fn_service_single">
                                    ...
                                    <div class="desc_holder"><p>Stone Coated Steel Roof is a world famous, unbelievably light roofing system that can enhance the look of your roof with its elegant design and great color range. Stone Coated Steel Roof is designed and manufactured to withstand all kinds of severe weather such as extreme hot and cold weather, strong wind, and heavy rain.Stone Coated Steel Roof can protect your home against all the destructive forces of nature because the tiles are designed to overlap and interlock into a horizontal fix system. Stone Coated Steel Roof is a product that can enhance the style of any home or commercial building and give it a lasting beautiful look.</p></div>

                                    <div class="fn_cs_check_list"><h3>Specification</h3><h6>CROSS SECTION OF A ROSER STONE COATED STREEL ROOFING TILE :</h6></div>

                                    <div class="img_holder"><img src="/img/cross.jpeg" alt="" /></div>
									...
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Easy Handling</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>ExcellenT Color And Design</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Outstanding Durability</p></div></li>
									</ul></div>
                                    {/* </div> */}
									...
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>School And University</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
