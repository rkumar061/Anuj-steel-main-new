                ...
                <ul>
                  ...
                  <li>
                    <span className="bread-current">
                      ACP Sheet (Aluminium Composite Panel)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="industify_fn_leftsidebar">
                ...
                <div className="industify_fn_service_single">
                  ...
                  <div class="desc_holder">
                    <p>
                      Aluminium composite panel is popularly known as ACP. It is
                      made up of aluminium composite material(ACM), which
                      contains two thinly coated aluminium sheets. Being
                      comprised of two distinct materials that is metals and
                      non-metal, as aluminium is a metal and polyethylene
                      plastic is a nonmetal, it overcomes the limitations and
                      the drawbacks of the original material.
                    </p>
                  </div>
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="item">
                          ...
                          <p>Offers a wider variety of colors and textures</p>
                        </div>
                      </li>
                    </ul>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/e-catalog/Disinfectant-Booth-FINAL.pdf">
                            <img src="/img/1A.jpeg" layout="fill" alt="" />
                          </a>
                          <h6>Disinfectant Booth</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                  ...
                  <div class="fn_cs_check_list">
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/ARAI-Test-Report-certi-1.pdf">
                            <img layout="fill" src="/img/certi-1.png" alt="" />
                          </a>
                          <h6>ARAI Test Report</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/Exova-Certification-E-84-certi-2.pdf">
                            <img layout="fill" src="/img/certi-2.png" alt="" />
                          </a>
                          <h6>Exova Certification E-84</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/Exova-Certification-EN-13501-WF-397641-certi-3.pdf">
                            <img layout="fill" src="/img/certi-3.png" alt="" />
                          </a>
                          <h6>Exova Certification EN-13501-WF-397641</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/Exova-Certification-EN-TS-15117-WF-397640-certi-4.pdf">
                            <img layout="fill" src="/img/certi-4.png" alt="" />
                          </a>
                          <h6>Exova Certification EN-TS-15117-WF-397640</h6>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/IIT-Bombay-VIVA-4mm-Thickness-PVDF-28-05-18-certi-5.pdf">
                            <img layout="fill" src="/img/certi-5.png" alt="" />
                          </a>
                          <h6>IIT Bombay VIVA 4mm Thickness PVDF 28-05-18</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/ISO-14001-2015-certi-6.pdf">
                      ...
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/SGS-REPORTS-4MM-0.50-certi-7.pdf">
                            <img layout="fill" src="/img/certi-7.png" alt="" />
                          </a>
                          <h6>SGS REPORTS 4MM 0.50</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/Shriram-Institute-certi-8.pdf">
                            <img layout="fill" src="/img/certi-8.png" alt="" />
                          </a>
                          <h6>Shriram Institute</h6>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/VIVA-7-Star-A-1-Corrugated-IIT-Bomnbay-certi-9.pdf">
                            <img layout="fill" src="/img/certi-9.png" alt="" />
                          </a>
                          <h6>VIVA 7 Star A-1 Corrugated IIT Bomnbay</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/Viva-Composite-Panel-Pvt-Ltd-IGBC-Certificate-certi-10.pdf">
                            <img layout="fill" src="/img/certi-10.png" alt="" />
                          </a>
                          <h6>Viva Composite Panel Pvt Ltd IGBC Certificate</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/VIVA-SGS-FR-TEST-REPORT-certi-11.pdf">
                            <img layout="fill" src="/img/certi-11.png" alt="" />
                          </a>
                          <h6>VIVA SGS FR TEST REPORT</h6>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="text-center p-2">
                          <a href="/img/certificates/Ecoplast-Adhesive-Filim-for-ACP-12.jpeg">
                            <img layout="fill" src="/img/certi-12.png" alt="" />
                          </a>
                          <h6>Ecoplast Adhesive Filim for ACP</h6>
                        </div>
                      </div>
                    </div>
                  </div>
