						...
						<div className="title_holder">
							...
							<div className="industify_fn_breadcrumbs">
								<ul>
									...
									<li className="separator"><span></span></li>
									<li><span className="bread-current">Deck Sheet</span></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div className="s_inner">
							...
							<div className="industify_fn_leftsidebar">
								...
								<div className="industify_fn_service_single">
									...
									<p>High load bearing capacity at low weight</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Excellent and durable thermal insulation</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Absolute water and vapour barrier</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Excellent air tightness and free of thermal bridges which results in considerable energy savings.</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Surface finished facings providing resistance to weather and aggressive environments</p></div></li>
									<li><div class="item"><span class="material-symbols-outlined arrow">arrow_forward</span> 
									<p>Capacity for rapid erection without lifting equipments; easier installation in hostile weather conditions</p></div></li>
									</ul></div>
                                    ...
                                    <p style={{fontSize: "18px",marginTop: "-20px"}}>Also the traditional Cold storage sectors & Modern Cold chain demands including Fruits, Vegetables, Dairy & Allied Products, Meat & Poultry, Sea Food, Food Processing, Beverages, Cold logistics, etc.</p>
